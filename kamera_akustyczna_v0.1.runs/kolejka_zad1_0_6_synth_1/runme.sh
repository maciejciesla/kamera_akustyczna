...
HD_PWD='C:/makiv2/kamera_akustyczna_v0.1/kamera_akustyczna_v0.1.runs/kolejka_zad1_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kolejka_zad1_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kolejka_zad1_0_6.tcl
