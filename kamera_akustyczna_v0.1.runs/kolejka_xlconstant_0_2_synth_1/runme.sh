...
HD_PWD='C:/makiv2/kamera_akustyczna_v0.1/kamera_akustyczna_v0.1.runs/kolejka_xlconstant_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kolejka_xlconstant_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kolejka_xlconstant_0_2.tcl
