...
HD_PWD='C:/makiv2/kamera_akustyczna_v0.1/kamera_akustyczna_v0.1.runs/kolejka_sim_clk_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kolejka_sim_clk_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kolejka_sim_clk_gen_0_1.tcl
