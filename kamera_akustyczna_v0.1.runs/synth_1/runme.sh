...
HD_PWD='C:/makiv2/kamera_akustyczna_v0.1/kamera_akustyczna_v0.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zad1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zad1.tcl
