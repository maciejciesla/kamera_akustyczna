...
#define POWTORZENIA_PETLI 100

#include <math.h>

#define distance_soundsource_OX				100						// odległość od osi OX głośnika [mm]
...
int main(void)
{
	...
	enable[2] = 1;				//enable BRAM
	
	for(uint8_t po = 0; po < POWTORZENIA_PETLI ; po++)	
	{
